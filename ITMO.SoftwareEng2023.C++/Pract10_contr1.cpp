...
public:
	...
	{
		cout << "Длина первой стороны: " << d1d2 << endl;
		cout << "Длина второй стороны: " << d2d3 << endl;
		cout << "Длина третьей стороны: " << d3d1 << endl;
	}
...
int main()
{
	...
	delete tr;  // Удаляю треугольник в куче, точки тоже удаляются т.к. это композиция
	cout << "----------------------" << endl;
